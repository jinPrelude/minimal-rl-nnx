...
| [PPO_TrXL](ppo_trxl.py) (very unstable. use GTrXL) | 560 | `python ppo_trxl.py` | 1+ hour (recommend GPU training) | [LunarLander-v3](ppo_trxl.py) |
| [PPO_GTrXL](ppo_gtrxl.py) | 589 | `python ppo_gtrxl.py` | 1+ hour (recommend GPU training) | [LunarLander-v3](ppo_gtrxl.py), [ALE/Breakout-v5](ppo_gtrxl_atari.py) |
